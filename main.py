...
def data():
    ...
    html_text = requests.get(
        "https://www.otodom.pl/pl/oferty/sprzedaz/mieszkanie/lodz?distanceRadius=0&page=1&limit=36&market=ALL&locations=%5Bcities_6-1004%5D&viewType=listing")
    ...
    for k in range(1, j + 1, 1):
        ...
        html_mlt = requests.get(
            "https://www.otodom.pl/pl/oferty/sprzedaz/mieszkanie/lodz?distanceRadius=0&page="+str(k)+"&limit=36&market=ALL&locations=%5Bcities_6-1004%5D&viewType=listing")
    ...
    for link in array:
        ...
        place = soup3.find_all('a', class_='css-1in5nid e1je57sb5')
